...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  const reviewSubmitHendler = async () => {
    if (!ratingText.trim().length || !ratingValue) {
      return toast.error("Please provide a rating text and rating balue");
    }
  ...
  return (
    <div className="container mx-auto px-2 md:px-4 py-10">
      <div className="grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <nav className="sticky top-0 px-2 w-fit mx-auto md:w-full md:px-5 py-3 mb-8 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-7">
            <ol
              className={`${
                currentNav === "bookings" ? "text-blue-600" : "text-gry-700"
            ...
            <ol
              className={`${
                currentNav === "amount" ? "text-blue-600" : "text-gry-700"
              } inline-flex mr-1 md:mr-5 item-center space-x-1 md:space-x-3`}
            >
              <li
      ...
      <RatingModal
        ...
        reviewSubmitHendler={reviewSubmitHendler}
        toggleRatingModal={toggleRatingModal}
      />
